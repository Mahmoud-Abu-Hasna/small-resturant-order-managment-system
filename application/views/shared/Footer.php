...
<div class="page-footer">
    <div class="page-footer-inner  text-center"> <?=date('Y') ?>
...
<script src="assets/global/plugins/jquery-validation/js/localization/messages_ar.min.js" type="text/javascript"></script>
...
<script src="assets/js/datatable_functions.js" type="text/javascript"></script>
